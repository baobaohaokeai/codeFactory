...
//		    log.info(result);
	...
	public String createIDao() {
		String path = Utililies.parseFilePath(ca.getSaveDir(), ca.getIdaoFilePath());
		String result = "IDao接口生成完成：" + path;
		try {
			String content = Utililies.readResourceFile(dir + "mysql_idao.tlp");
			// package
			content = Utililies.parseTemplate(content, "IDaoPackage", Utililies.getSuperPackage(ca.getIdaoPackage()));
			content = Utililies.parseTemplate(content, "EntityName", ca.getEntityName());
			content = Utililies.parseTemplate(content, "EntityPackage", Utililies.getSuperPackage(ca.getEntityPackage()));
			content = Utililies.parseTemplate(content, "IDaoName", ca.getIdaoName());
			Utililies.writeContentToFile(path, content);
		}catch (Exception e) {
			result = "IDao接口生成失败：" + e.getMessage();
		}
		return result;
	}

	public String createDao() {
		String path = Utililies.parseFilePath(ca.getSaveDir(), ca.getDaoFilePath());
		String result = "Dao类生成完成：" + path;
		try {
			String content = Utililies.readResourceFile(dir + "mysql_dao.tlp");
			// package
			content = Utililies.parseTemplate(content, "DaoPackage", Utililies.getSuperPackage(ca.getDaoPackage()));
			content = Utililies.parseTemplate(content, "IDaoPackage", Utililies.getSuperPackage(ca.getIdaoPackage()));
			content = Utililies.parseTemplate(content, "EntityPackage", Utililies.getSuperPackage(ca.getEntityPackage()));
	...
	public String createDaoMapper() {
		...
		try {
			String content = Utililies.readResourceFile(dir + "mysql_mapper.tlp");
			// package
			content = Utililies.parseTemplate(content, "DaoPackage", Utililies.getSuperPackage(ca.getDaoPackage()));
			content = Utililies.parseTemplate(content, "EntityPackage", Utililies.getSuperPackage(ca.getEntityPackage()));
	...
	public String createIService() {
		...
		try {
			...
			// package
			content = Utililies.parseTemplate(content, "IServicePackage", Utililies.getSuperPackage(ca.getIservicePackage()));
	...
	public String createService() {
		...
		try {
			...
			content = Utililies.parseTemplate(content, "IServicePackage", Utililies.getSuperPackage(ca.getIservicePackage()));
			content = Utililies.parseTemplate(content, "IServiceName", ca.getIserviceName());
			content = Utililies.parseTemplate(content, "ServicePackage", Utililies.getSuperPackage(ca.getServicePackage()));
	...
	public String createController() {
        ...
        try {
            ...
            // package
            content = Utililies.parseTemplate(content, "ControllerPackage", Utililies.getSuperPackage(ca.getControllerPackage()));
            ...
            content = Utililies.parseTemplate(content, "EntityName", ca.getEntityName());
            content = Utililies.parseTemplate(content, "EntityNameLower", CommonUtils.firstCharToLowerCase(getEntityName()));
            content = Utililies.parseTemplate(content, "EntityPackage", Utililies.getSuperPackage(ca.getEntityPackage()));
            content = Utililies.parseTemplate(content, "IServicePackage", Utililies.getSuperPackage(ca.getIservicePackage()));
            content = Utililies.parseTemplate(content, "IServiceName", ca.getIserviceName());
	...
	public String createWeb() {
	    ...
	    String javaPath = "";
        String result = "";
        String [] fileNames = {"initJqGrid.js","report.js","report.jsp"};
        String [] fileTlpNames = {"initJqGridJs.tlp","reportJs.tlp","reportJsp.tlp"};
        try {
        	for(int i = 0;i<fileNames.length;i++){
        		javaPath = Utililies.parseFilePath(ca.getSaveDir3()+"/" + 
        						CommonUtils.firstCharToLowerCase(ca.getEntityName()),fileNames[i]);
        		result = fileNames[i] + "生成完成：" + javaPath;
        		content = Utililies.readResourceFile(dir + "web/" + fileTlpNames[i]);
                content = Utililies.parseTemplate(content, "EntityNameLower", CommonUtils.firstCharToLowerCase(getEntityName()));
                Utililies.writeContentToFile(javaPath, content);
        	}
        } catch (Exception e) {
            result = "web页面相关文件生成失败：" + e.getMessage();
        }
        return result;
	}
