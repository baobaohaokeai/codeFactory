...
public class CreAttr implements Cloneable {
    ...
    public String getIdaoFilePath() {
		return idaoFilePath;
	}

	public void setIdaoFilePath(String idaoFilePath) {
		this.idaoFilePath = idaoFilePath;
	}
	...
	public void setIdaoPackage(String idaoPackage) {
		this.idaoPackage = idaoPackage;
	}

	public String getSaveDir3() {
		return saveDir3;
	}

	public void setSaveDir3(String saveDir3) {
		this.saveDir3 = saveDir3;
	}
	...
	public String toString() {
		...
		sb.append("; idaoName=" + (idaoName == null ? "null" : idaoName.toString()));
		sb.append("; daoPackage=" + (daoPackage == null ? "null" : daoPackage.toString()));
		sb.append("; idaoPackage=" + (idaoPackage == null ? "null" : idaoPackage.toString()));
		sb.append("; daoFilePath=" + (daoFilePath == null ? "null" : daoFilePath.toString()));
		sb.append("; idaoFilePath=" + (idaoFilePath == null ? "null" : idaoFilePath.toString()));
	...
	public void replaceAll(String table) {
		...
		this.idaoName = Utililies.parseTemplate(this.idaoName, "EntityName", this.entityName);
		this.daoPackage = Utililies.parseTemplate(this.daoPackage, "EntityName", this.entityName);
		this.idaoPackage = Utililies.parseTemplate(this.idaoPackage, "EntityName", this.entityName);
		this.daoFilePath = Utililies.parseTemplate(this.daoFilePath, "EntityName", this.entityName);
		this.idaoFilePath = Utililies.parseTemplate(this.idaoFilePath, "EntityName", this.entityName);
